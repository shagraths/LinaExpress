    ...
    <tbody>
        ...
        <?php foreach ($ciudades as $filas): ?>
            ...
            <tr align="center">
                ...
                <td><button onclick="cargar_ciudad(<?= $filas->id_ciudad; ?>, '<?= $filas->nombre_ciudad; ?>','<?= $filas->tipo_ciudad; ?>', '<?= $filas->observacion; ?>', '<?= $filas->estado; ?>')"><span class="ui-icon ui-icon-circle-arrow-n"></span></button></td>    
            </tr>
            <? else: ?>
